        ...
        <div className="row">
          ...
          <div className="col-md-6 align-self-center">
            <div className={styles.nftText}>
              ...
              <h5 className="mb-4">Arcade metaverse world</h5>
              <p>Get ready for the ultimate metaverse experience!</p>
              <p>
                We saw NFTs across web3 with no purpose, no direction, longing
                for something more. So we created Arcade Metaverse from the
                ground up to give the entire NFT community a place to care
                about, a place to call home.
              </p>
              <p>
                Arcade Metaverse is an adventurous world with different regions
                for you to discover and build with your friends.
              </p>
            </div>
          </div>
        </div>
